...
「ものづくりの質をより良くしていくこと」を軸に、エンジニアリングとプロセス改善の両面からキャリアを築いていきたいと考えています。

これまで「実際にものを作るエンジニアリング」と「開発プロセスを効率化するスクラムマスター」という2つのロールでスキルを伸ばしてきました。今後は、以下のいずれかを主軸に据えながら、隣接領域への越境を続けていく方針です。

- **エンジニアを主軸とする方向**: モバイルを起点に、バックエンドやフロントエンドなど周辺の技術領域へ守備範囲を広げ、技術面から課題解決に貢献する
- **プロセス最適化を主軸とする方向**: 少人数・密なコミュニケーションを前提とした開発体制を設計し、アウトプットの量と質を最大化する責任を担う

最終的な目的は「より良いものづくりの追求」にあり、自らエンジニアリングを行うか、複数人のオーケストレーションを通じてアウトプットを高めるかは、その手段の違いと捉えています。
...
| 期間                    | 会社名             | 職務                      |
| :---------------------- | :----------------- | :------------------------ |
| 2023年01月 – 現在       | 株式会社HEARTBEATS     | 技術顧問 (React Native)   |
| 2025年03月 – 2025年05月 | 株式会社えーいち     | 技術顧問 (React Native)   |
| 2022年03月 – 2023年04月 | BonBon株式会社     | 技術顧問 (React Native)   |
| 2019年10月 – 2021年12月 | シェアフル株式会社 | エンジニア (React Native) |
| 2020年09月 – 2021年03月 | 株式会社HEARTBEATS     | 技術顧問 (React Native)   |
...
* [React Tokyo フェス2026でのポスターセッション](https://x.com/mrtry_/status/2027951613865079254)
* [達人への道——専門技能を習得するための学習の地図 - Speaker Deck](https://speakerdeck.com/mrtry/da-ren-henodao-zhuan-men-ji-neng-woxi-de-surutamenoxue-xi-nodi-tu)
...
| 2026年 | アドバンスド認定スクラムマスター (Advanced Certified ScrumMaster®) |
